...
Пакет `rolldown-vite` реализует Vite 7 с Rolldown, но без остальных изменений Vite 8. Его можно использовать как промежуточный шаг при переходе на Vite 8. Чтобы перейти с обычного Vite 7 на `rolldown-vite`, смотрите [руководство по интеграции Rolldown](/guide/rolldown) в документации Vite 7.
...
Сначала ознакомьтесь с [Руководством по переходу с v6](/guide/migration) в документации Vite v7, чтобы увидеть необходимые изменения для переноса вашего приложения на Vite 7, а затем продолжите с изменениями на этой странице.
