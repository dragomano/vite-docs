...
![Обложка объявления Vite 5](/og-image-announcing-vite5.webp)
...
- [Согласование поведения при разработке и предварительном просмотре HTML-кода](https://v5.vite.dev/guide/migration#align-dev-and-preview-html-serving-behaviour)
...
- [Обновлено поведение `experimentalDecorators` и `useDefineForClassFields` в TypeScript](https://v5.vite.dev/guide/migration#update-experimentaldecorators-and-usedefineforclassfields-typescript-behaviour)
