...
TL;DR: Вышла первая бета Vite 8 на базе [Rolldown](https://rolldown.rs/). Vite 8 обеспечивает значительно более быстрые финальные сборки и открывает путь к будущим улучшениям. Попробовать можно, обновив `vite` до версии `8.0.0-beta.0` и прочитав [руководство по миграции](https://main.vite.dev/guide/migration).
...
2. Rollup — для бандлинга, чанкинга и оптимизации финальных сборок
...
- Время создания финальной сборки в Linear сократилось с 46 до 6 секунд
