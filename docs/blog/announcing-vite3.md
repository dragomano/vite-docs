...
head:
  ...
  - - meta
    - property: og:image
      content: https://vite-docs.ru/og-image-announcing-vite3.webp
  - - meta
    - property: og:url
      content: https://vite-docs.ru/blog/announcing-vite3
  - - meta
...
[![График новых задач и запросов на внесение изменений в Vite](../images/v3-new-open-issues-and-PRs.webp)](https://www.repotrends.com/vitejs/vite)
