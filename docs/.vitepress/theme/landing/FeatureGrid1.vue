...
<template>
  ...
  >
    <div class="flex flex-col gap-3 justify-between">
      <div class="p-5 sm:p-10 flex flex-col gap-3">
        ...
        <p class="sm:max-w-[28rem] text-pretty">
          Файлы предоставляются через встроенный ESM, с молниеносной предсборкой зависимостей.
        </p>
      </div>
    ...
    <div class="flex flex-col gap-3 justify-between border-r-0">
      <div class="p-5 sm:p-10 flex flex-col gap-3">
        <h5 class="text-white">Молниеносная HMR</h5>
        <p class="max-w-[26rem] text-pretty">
          Изменения применяются мгновенно при сохранении — даже в очень большом приложении.
        </p>
      </div>
    ...
    <div class="flex flex-col gap-3 justify-between border-r-0 border-b-0">
      <div class="p-5 sm:p-10 flex flex-col gap-3">
        ...
        <p class="max-w-[25rem] text-pretty">
          Продвинутый tree-shaking, встроенная минификация, тонкий контроль над разбиением чанков — всё это на базе Rolldown.
        </p>
      </div>
      <div class="relative p-10 sm:p-15 flex justify-center bg-[#370a7f]">
        <img
