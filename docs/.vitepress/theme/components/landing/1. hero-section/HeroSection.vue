...
<template>
  <div class="hero">
    <div class="container">
      ...
      <!-- Heading -->
      <h1>Инструмент сборки<br />для веба</h1>
      <!-- Tagline -->
      <h3>
        Vite — это молниеносно быстрый инструмент сборки фронтенда, который обеспечивает работу следующего поколения веб-приложений.
      </h3>
