  ...
  >
    ...
    >
      ...
      <p class="text-white text-3xl text-pretty max-w-[35rem]">
        Vite: Документальный фильм — повторная премьера
      </p>
      <p class="text-white/70 md:text-lg max-w-[35rem] text-pretty">
        ...
        которую мы писали вместе. И поучаствуйте в живом эфире на сцене,
        чтобы обсудить наше прошлое, настоящее и будущее. Будем ждать вас!
      </p>
    ...
    <div class="flex items-center justify-center p-10 md:min-h-[30rem]">
      <img
        ...
        inert
        loading="lazy"
        alt="Vite-сообщество: Эван Ю, Матиас Капеллетто, Бьёрн Лу, Энтони Фу, Сапфи Ред, Доминик Гёпель, Владимир Шеремет, Райан Карниато, Педро Каттори, Марк Далглиш, Рич Харрис, Фред Шотт, Эрик Саймонс, Тео Браун, Дэвид Крамер, Миско Хевери"
      />
    </div>
  </div>
</template>
