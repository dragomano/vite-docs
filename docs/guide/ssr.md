...
Затем в `server.js` нам нужно добавить некоторую логику, специфичную для рабочего режима, проверяя `process.env.NODE_ENV`:
