<!--
  ...
  Не стесняйтесь отправлять пулреквест, добавляющий новый раздел со ссылкой на руководство по развёртыванию вашей платформы, при условии, что оно соответствует следующим критериям:
