...
Vite 6 формализует концепцию окружений. До версии Vite 5 существовало два неявных окружения (`client` и, опционально, `ssr`). Новый Environment API позволяет пользователям и авторам фреймворков создавать столько окружений, сколько необходимо для соответствия работы их приложений в реальной среде. Эта новая возможность потребовала масштабной внутренней переработки, но большое внимание было уделено обратной совместимости. Основная цель Vite 6 — обеспечить максимально плавный переход экосистемы на новую мажорную версию, откладывая внедрение новых API до тех пор, пока достаточное количество пользователей не перейдёт на неё, а авторы фреймворков и плагинов не подтвердят работоспособность нового дизайна.
