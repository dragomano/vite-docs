...
Однако это может быть неинтуитивно для тех, кто приходит из других языков программирования или более старых версий TypeScript.
Вы можете прочитать больше о переходе в [заметках о выпуске TypeScript 3.7](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-7.html#the-usedefineforclassfields-flag-and-the-declare-property-modifier).
...
- Типы для внедряемых Vite [постоянных переменных](./env-and-mode#env-variables) в `import.meta.hot`
