...
Файлы `.jsx` и `.tsx` также поддерживаются из коробки. Транспиляция JSX также осуществляется с помощью [Oxc Transformer](https://oxc.rs/docs/guide/usage/transformer/).
