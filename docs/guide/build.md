...
<ScrimbaLink href="https://scrimba.com/intro-to-vite-c03p6pbbdq/~037q?via=vite" title="Сборка для продакшена">Посмотреть интерактивный урок на Scrimba</ScrimbaLink>
...
При включённом флаге `--watch` любые изменения в файлах, которые подлежат сборке, будут запускать пересборку. Обратите внимание: изменения в самом конфигурационном файле и его зависимостях требуют перезапуска команды сборки.
