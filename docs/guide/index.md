...
Запуск `vite` запускает dev-сервер, используя текущий рабочий каталог в качестве корневого. Вы можете указать альтернативную корневую директорию с помощью `vite serve some/sub/dir`.
