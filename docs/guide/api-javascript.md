...
interface ViteDevServer {
   ...
   * - Может использоваться для подключения пользовательских посредников к серверу разработки.
...
**Ссылки по теме:** [server.fs.allow](/config/server-options.md#server-fs-allow)
...
**Ссылки по теме:** [`.env` Files](./env-and-mode.md#env-files)
...
**Ссылки по теме:** [Path Normalization](./api-plugin.md#path-normalization)
